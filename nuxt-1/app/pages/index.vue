    ...
    <section class="bg-[#f1f1f1]">
        <div class="container flex flex-col lg:flex-row items-center py-20 gap-10">
            <div class="flex-1 order-2 lg:order-1 text-center lg:text-left">
                ...
                <button class="px-4 py-2 text-white self-start bg-[#f79f1a] rounded-md text-lg cursor-pointer">
                    Browse Recipes
                </button>
                </div>
                <div class="flex-1 order-1 lg:order-2">
                <NuxtImg src="/nuxt-course-hero.png" format="webp" sizes="xs: 100vw sm: 667px"  alt="" />
            </div>
        </div>
    </section>
